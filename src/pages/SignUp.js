      ...
      */}
      <SignUpDiv>
        <form className='shadow bg-white rounded'>
          ...
          <input type="password" required value={pw} onChange={(e)=> setPw(e.target.value)}  minLength={8} maxLength={16} />
          ...
          <button className='border rounded px-3 py-2 shadow ' onChange={(e)=> handleSignUp(e)}>
            회원가입
            </button>
